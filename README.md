...
Below are a few resources (written by economists and closely related researchers) that I’ve found useful for thinking about how to use modern AI tools in applied work—both as a *productivity tool* and as an *object of study*.

**Economics-focused resources**

- [Anton Korinek: The Economics of Transformative AI (NBER Reporter, 2024)](https://www.nber.org/reporter/2024number4/economics-transformative-ai) - Overview of key economic questions around transformative AI
- [Generative AI for Economic Research: Use Cases and Implications for Economists (AEA JEL)](https://www.aeaweb.org/articles?id=10.1257/jel.20231736) - Practical discussion of how generative AI can enter the research workflow
- [Kevin A. Bryan: *The Economic Impacts of AI: A Multidisciplinary, Multibook Review* (PDF)](https://kevinbryanecon.com/BryanAIBookReview.pdf) - Broad overview of the economics of AI and relevant literatures
- [Kevin Bryan on AI for Economics Education (Princeton Bendheim Center event)](https://bcf.princeton.edu/events/kevin-bryan-on-ai-for-economics-education/) - Talk/event page with framing and materials
- [Alexander W. Bartik, Arpit Gupta, and Daniel Milo: *The Costs of Housing Regulation: Evidence From Generative Regulatory Measurement* (PDF)](https://www.alexbartik.com/papers/GenRegMeasure_Sep142024.pdf) - Example of using generative methods for measurement in applied work
- [Stephen Hansen and coauthors: *Large Language Models in Economics* (CEPR DP19479)](https://cepr.org/publications/dp19479) - Research and perspective on LLMs in economics
- [Inference for Regression with Variables Generated by AI or Machine Learning (arXiv:2402.15585)](https://arxiv.org/abs/2402.15585) - Useful for thinking carefully about inference with AI-generated variables
- [Scott Cunningham: “Generative AI and Worker Productivity”](https://causalinf.substack.com/p/generative-ai-and-worker-productivity) - Accessible discussion of evidence and identification around generative AI’s labour-market impacts
